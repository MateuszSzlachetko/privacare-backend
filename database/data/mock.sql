...
insert into slot (id, doctor_id, starts_at, reserved)
values ('c4b6a866-f6cd-4130-bd8c-64d54bc92be6',
        '9dbae116-3954-4a2c-9308-31fb971dc6fc',
        '2023-11-11T10:00:00',
        'true'),
       ('670ea9e6-138c-4ac6-88de-479415733929',
        '9dbae116-3954-4a2c-9308-31fb971dc6fc',
        '2023-11-11T11:00:00',
        'true');

insert into appointment (id, creator_id, patient_id, slot_id)
values ('1219e3da-4151-4baa-9256-86679e350a3f',
        '9dbae116-3954-4a2c-9308-31fb971dc6fc',
        '432b984b-3a3e-4078-af5d-c620bd3b9159',
        'c4b6a866-f6cd-4130-bd8c-64d54bc92be6'),
